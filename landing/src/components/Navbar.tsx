    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#030407]/80 backdrop-blur-md border-b border-white/[0.06]">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-xs font-mono uppercase tracking-wider text-slate-400">
          <a href="#comparativa" className="hover:text-gold transition-colors">Comparativa</a>
          <a href="#dictamen" className="hover:text-gold transition-colors">El Dictamen PDF</a>
          <a href="#oferta" className="hover:text-gold transition-colors">Plan Fundador</a>
          <a href="#garantia" className="hover:text-gold transition-colors">Garantía</a>
